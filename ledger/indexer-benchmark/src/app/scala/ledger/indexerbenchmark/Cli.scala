...
object Cli {
  ...
  private[this] val Parser: OptionParser[Config] =
    new OptionParser[Config]("indexer-benchmark") {
      ...
      opt[Int]("update-generation-rate")
        .text("Sets the number of updates per second generated by a test ReadService. Default is 50000.")
        .action((value, config) => config.copy(updateGenerationRate = value))

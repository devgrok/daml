...
private[testtool] object LedgerParticipantTestContext {
...
private[testtool] final class LedgerParticipantTestContext private[participant] (
    val ledgerId: String,
  ...
  import LedgerParticipantTestContext._
  ...
  override val nextKeyId: () => String = nextId("key")
  ...
  override def uploadDarFile(bytes: ByteString): Future[Unit] =
  ...
  override def checkpoints(n: Int, from: LedgerOffset = referenceOffset)(
      parties: Party*
